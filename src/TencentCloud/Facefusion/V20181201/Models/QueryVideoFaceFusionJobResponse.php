...
/**
 * QueryVideoFaceFusionJob返回参数结构体
 *
 ...
 * @method VideoFaceFusionOutput getVideoFaceFusionOutput() 获取视频人脸融合输出的结果信息
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setVideoFaceFusionOutput(VideoFaceFusionOutput $VideoFaceFusionOutput) 设置视频人脸融合输出的结果信息
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getJobStatusCode() 获取任务状态码，1-排队中，3-处理中，5-处理失败，7-处理完成
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setJobStatusCode(integer $JobStatusCode) 设置任务状态码，1-排队中，3-处理中，5-处理失败，7-处理完成
注意：此字段可能返回 null，表示取不到有效值。
...
class QueryVideoFaceFusionJobResponse extends AbstractModel
{
    ...
    /**
     * @var VideoFaceFusionOutput 视频人脸融合输出的结果信息
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $VideoFaceFusionOutput;

    /**
     * @var integer 任务状态码，1-排队中，3-处理中，5-处理失败，7-处理完成
注意：此字段可能返回 null，表示取不到有效值。
     */
     ...
     * @param VideoFaceFusionOutput $VideoFaceFusionOutput 视频人脸融合输出的结果信息
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $JobStatusCode 任务状态码，1-排队中，3-处理中，5-处理失败，7-处理完成
注意：此字段可能返回 null，表示取不到有效值。
